...
window.TEMPLATES["poster"] = {
  ...
  body[data-tpl="poster"]{margin:0;background:var(--crema);color:var(--tinta);font-family:'Space Grotesk',system-ui,sans-serif;-webkit-font-smoothing:antialiased;padding-bottom:122px;overflow-x:hidden;}
  ...
  body[data-tpl="poster"] .pg-name{font-family:'Anton';color:var(--crema);font-size:clamp(54px,17vw,96px);line-height:.82;letter-spacing:.5px;text-transform:uppercase;margin:0;}
  ...
  body[data-tpl="poster"] .pg-nav button{flex:0 0 auto;font-family:'Anton';font-size:15px;letter-spacing:1px;text-transform:uppercase;color:var(--crema);background:none;border:none;padding:11px 15px;cursor:pointer;white-space:nowrap;}
  ...
  body[data-tpl="poster"] .pg-sechead h2{font-family:'Anton';font-size:clamp(28px,8vw,46px);line-height:.9;letter-spacing:.5px;text-transform:uppercase;margin:0;}
  body[data-tpl="poster"] .pg-sechead .ct{font-family:'Anton';font-size:16px;color:var(--tinta);background:var(--acento);border-radius:0;padding:3px 9px;}

  /* ---------- BENTO GRID ---------- */
  body[data-tpl="poster"] .pg-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;}
  body[data-tpl="poster"] .pg-tile{position:relative;min-height:128px;border:3px solid var(--tinta);box-shadow:5px 5px 0 var(--tinta);overflow:hidden;display:flex;flex-direction:column;justify-content:flex-end;padding:12px;transition:transform .12s, box-shadow .12s;}
  ...
  body[data-tpl="poster"] .pg-pname{position:relative;font-family:'Anton';font-size:clamp(22px,6vw,32px);line-height:.85;letter-spacing:.4px;text-transform:uppercase;margin:0;}
  ...
  body[data-tpl="poster"] [data-add]{width:34px;height:34px;border:2.5px solid var(--tinta);background:var(--crema);color:var(--tinta);font-family:'Anton';font-size:20px;line-height:1;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;box-shadow:2px 2px 0 var(--tinta);}
  body[data-tpl="poster"] [data-add]:active{transform:translate(2px,2px);box-shadow:0 0 0 var(--tinta);}
  body[data-tpl="poster"] [data-sub]{width:30px;height:30px;border:2.5px solid var(--tinta);border-right:none;background:var(--crema);color:var(--tinta);font-family:'Anton';font-size:18px;line-height:1;cursor:pointer;display:none;align-items:center;justify-content:center;}
  body[data-tpl="poster"] [data-cant]{display:none;min-width:26px;height:30px;line-height:30px;text-align:center;font-family:'Anton';background:var(--crema);color:var(--tinta);border-top:2.5px solid var(--tinta);border-bottom:2.5px solid var(--tinta);}
  ...
  body[data-tpl="poster"] .pg-end{text-align:center;padding:26px 0 8px;font-family:'Anton';font-size:14px;letter-spacing:2px;text-transform:uppercase;color:var(--tinta);opacity:.5;}

  /* ---------- CARRITO ---------- */
  body[data-tpl="poster"] #cart-fab{background:var(--tinta) !important;color:var(--crema) !important;border:3px solid var(--tinta) !important;border-radius:0 !important;box-shadow:4px 4px 0 var(--acento) !important;font-family:'Anton' !important;letter-spacing:.05em;text-transform:uppercase;}
  ...
  body[data-tpl="poster"] #cart h2{font-family:'Anton';text-transform:uppercase;letter-spacing:1px;}
  ...
  body[data-tpl="poster"] #cart .cart-row-sub{color:var(--tinta) !important;font-family:'Anton';}
  body[data-tpl="poster"] #cart .cart-total strong{font-family:'Anton';}
  ...
  body[data-tpl="poster"] #enviar{border-radius:0 !important;font-family:'Anton';text-transform:uppercase;letter-spacing:.05em;box-shadow:4px 4px 0 var(--tinta) !important;}

...
const UNA_CAT = !cfg || cfg.categoriaUnica !== false; // mostrar SOLO la categoría seleccionada (default: sí)
...
$("#enviar").addEventListener("click", () => {
  ...
  if (entrega === "Delivery" && !dir) return alert("Falta la dirección de entrega 🛵");

  let m = `*Nuevo pedido — ${R.nombre}*\n\n*Cliente:* ${nombre}\n*Entrega:* ${entrega}\n`;
  if (entrega === "Delivery") m += `*Dirección:* ${dir}\n`;
  m += `\n*Pedido:*\n`;

...
// Selector de ciudad pre-login del panel Admin. Define a qué backend (Riobamba /
// San Cristóbal) se conecta. Se muestra una vez; la elección se recuerda.
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center gap-8 p-8">
      <div className="text-center">
        ...
        <p className="text-gray-400 text-sm mt-2">¿Qué ciudad querés administrar?</p>
      </div>
